<%-- 
    ...
    Created on : 29-Nov-2018, 21:57:09
    Author     : Windows10
--%>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-8 col-lg-6 pb-5">
                        ...
                        <br>
                        <br>
                        <form action="HomepageView.jsp" method="post">
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="email" class="form-control" id="email" name="email" placeholder="ELK-S-Autopart@gmail.com" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <a href="HomepageView.jsp" class="btn btn-lg btn-primary" role="button" aria-pressed="true">Submit</a>
                                    </div>
                                </div>
